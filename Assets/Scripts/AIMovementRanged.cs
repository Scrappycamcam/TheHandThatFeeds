...
public class AIMovementRanged : MonoBehaviour {
    ...
    private void AttackPlayer()
    {
        ...
        else
        {
            ...
            {
                transform.LookAt(c1);
                projectileRanged _Shooty = Instantiate(_projectile, _swordPos, this.transform.rotation).GetComponent<projectileRanged>();
                _Shooty._direction = _player.transform.position;
                _Shooty._damage = _enemyDamage;
                _Shooty._maxRange = _damageDistance;
